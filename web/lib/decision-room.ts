...
export type RoadmapWeek = {
  gw: number; action: string; status: string; formation: string | null;
  bank_after: NumberOrNull; free_transfers_after: NumberOrNull;
  mean_points_with_captain: NumberOrNull; robust_points_with_captain: NumberOrNull;
  moves: { out: string; in: string; hit: boolean }[];
};
